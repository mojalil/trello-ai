...
const Header = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl">
        <div className="absolute top-0 left-0 w-full h-96 bg-gradient-to-br from-pink-400 to-[#0055D1] rounded-md filter blur-3xl
         opacity-50
         -z-50
      ...
      <div className="flex items-center space-x-5 flex-1 justify-end">
        ...
        <Avatar name="Mo Jalil" round color='#0055D1' size="50"/>
      </div>
      </div>
